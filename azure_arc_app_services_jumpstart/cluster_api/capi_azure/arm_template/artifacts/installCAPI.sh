...
echo ""
workspaceResourceId=$(sudo -u $adminUsername az resource show --resource-group $AZURE_RESOURCE_GROUP --name $logAnalyticsWorkspaceName --resource-type "Microsoft.OperationalInsights/workspaces" --query id -o tsv)
